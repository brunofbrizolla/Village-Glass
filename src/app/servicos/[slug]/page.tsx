...
const services = [
  {
    ...
    details: "Transforme seu banho em um momento de relaxamento com nossos boxes. Oferecemos modelos de abrir, correr, de canto ou frontais, com diversas opções de puxadores e acabamentos em alumínio ou inox. Vidro temperado de 8mm para sua total segurança.",
  ...
  },
  {
    ...
    details: "O espelho certo pode transformar completamente a percepção de um ambiente. Trabalhamos com espelhos de cristal de alta qualidade, com acabamento lapidado ou bisotê. Instalação colada ou com botões franceses, em paredes inteiras, teto ou móveis.",
  ...
  },
  {
    ...
    details: "As portas deslizantes são a solução perfeita para integrar ambientes ou economizar espaço. Trabalhamos com trilhos aparentes ou embutidos, oferecendo suavidade no deslize e segurança reforçada. Ideais para passagens entre sala e varanda, divisórias de escritórios ou closets.",
  ...
  },
  {
    ...
    details: "O fechamento de sacada (sistema Reiki ou similares) permite que você utilize sua varanda o ano todo, independente do clima. Proporciona redução de ruídos externos, protege contra chuva e vento, e aumenta a área útil do seu imóvel com total transparência e elegância.",
  ...
  },
  {
    ...
    details: "Segurança é prioridade quando falamos de guarda-corpos. Utilizamos vidros laminados e temperados de alta resistência, fixados com pinos de aço inox, torres ou embutidos no piso. Design minimalista que garante proteção sem obstruir a visão.",
...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-headline font-bold mb-4">Como trabalhamos</h2>
            <p className="text-muted-foreground">O passo a passo para a realização do seu projeto</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-border/50 text-center space-y-4">
              <div className="w-12 h-12 bg-primary text-white rounded-full flex items-center justify-center font-bold text-xl mx-auto">3</div>
              <h4 className="font-bold text-xl">Instalação Limpa</h4>
              <p className="text-muted-foreground text-sm">Nossa equipe realiza a instalação com agilidade, limpeza e total precisão técnica.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Intro Section - Reused from Home */}
